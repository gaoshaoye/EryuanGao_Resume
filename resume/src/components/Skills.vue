<template>
  <div class="Eryuan-resume-skills mt-18">
    <div class="Eryuan-resume-h1">Skills</div>
  ...
  data(){
    return{
      textList: [
        ...
        'Have passion to fully communicate difficulties and improvement opinions with designers',
      ]
